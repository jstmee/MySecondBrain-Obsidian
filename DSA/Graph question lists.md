...
4. [Number of Connected Components](https://leetcode.com/problems/number-of-connected-components-in-an-undirected-graph/)  
...
11\. [Number of Closed Islands](https://leetcode.com/problems/number-of-closed-islands/) 

12\. [Number of Enclaves](https://leetcode.com/problems/number-of-enclaves/) 

13\. [Count Sub Islands](https://leetcode.com/problems/count-sub-islands/)

 14\. [Island Perimeter](https://leetcode.com/problems/island-perimeter/) 

15\. [Shortest Path in Binary Matrix](https://leetcode.com/problems/shortest-path-in-binary-matrix/)

**Basic Validation:** 

16\. [Graph Valid Tree](https://leetcode.com/problems/graph-valid-tree/) 

17\. [Find if Path Exists in Graph](https://leetcode.com/problems/find-if-path-exists-in-graph/) 

18\. [All Paths From Source to Target](https://leetcode.com/problems/all-paths-from-source-to-target/) 

19\. [Find the Town Judge](https://leetcode.com/problems/find-the-town-judge/) 

20\. [Keys and Rooms](https://leetcode.com/problems/keys-and-rooms/)

### **Phase 2: Cycle Detection & Topological Sort**

21. [Course Schedule](https://leetcode.com/problems/course-schedule/)  
...
24. [Redundant Connection II](https://leetcode.com/problems/redundant-connection-ii/)  
25. [Find Eventual Safe States](https://leetcode.com/problems/find-eventual-safe-states/)  
26. [Alien Dictionary](https://leetcode.com/problems/alien-dictionary/)  
27. [Sequence Reconstruction](https://leetcode.com/problems/sequence-reconstruction/)  
28. [Minimum Height Trees](https://leetcode.com/problems/minimum-height-trees/)  
29. [Sort Items by Groups Respecting Dependencies](https://leetcode.com/problems/sort-items-by-groups-respecting-dependencies/)  
30. [Parallel Courses](https://leetcode.com/problems/parallel-courses/)  
31. [Parallel Courses II](https://leetcode.com/problems/parallel-courses-ii/)  
32. [Build a Matrix With Conditions](https://leetcode.com/problems/build-a-matrix-with-conditions/)  
33. [Largest Color Value in a Directed Graph](https://leetcode.com/problems/largest-color-value-in-a-directed-graph/)  
34. [Longest Cycle in a Graph](https://leetcode.com/problems/longest-cycle-in-a-graph/)  
35. [Longest Path With Different Adjacent Characters](https://leetcode.com/problems/longest-path-with-different-adjacent-characters/)
...
37\. [Word Ladder II](https://leetcode.com/problems/word-ladder-ii/) 

38\. [Open the Lock](https://leetcode.com/problems/open-the-lock/)

39\. [Minimum Knight Moves](https://leetcode.com/problems/minimum-knight-moves/) 

40\. [Shortest Bridge](https://leetcode.com/problems/shortest-bridge/)

**Dijkstra's Algorithm:** 

41\. [Network Delay Time](https://leetcode.com/problems/network-delay-time/) 

42\. [Path with Maximum Probability](https://leetcode.com/problems/path-with-maximum-probability/) 

43\. [Cheapest Flights Within K Stops](https://leetcode.com/problems/cheapest-flights-within-k-stops/) 

44\. [Path with Minimum Effort](https://leetcode.com/problems/path-with-minimum-effort/) 

45\. [Swim in Rising Water](https://leetcode.com/problems/swim-in-rising-water/) 

46\. [Minimum Cost to Reach Destination in Time](https://leetcode.com/problems/minimum-cost-to-reach-destination-in-time/) 

47\. [Minimum Weighted Subgraph With Required Paths](https://leetcode.com/problems/minimum-weighted-subgraph-with-the-required-paths/) 

48\. [Minimum Obstacle Removal to Reach Corner](https://leetcode.com/problems/minimum-obstacle-removal-to-reach-corner/) 

49\. [Minimum Cost of a Path With Special Roads](https://leetcode.com/problems/minimum-cost-of-a-path-with-special-roads/)

 50\. [Find the City With Smallest Number of Neighbors](https://leetcode.com/problems/find-the-city-with-the-smallest-number-of-neighbors-at-a-threshold-distance/)

### **Phase 4: Union-Find**

51. [Number of Provinces](https://leetcode.com/problems/number-of-provinces/)  
52. [Redundant Connection](https://leetcode.com/problems/redundant-connection/)  
53. [Most Stones Removed with Same Row or Column](https://leetcode.com/problems/most-stones-removed-with-same-row-or-column/)  
54. [Accounts Merge](https://leetcode.com/problems/accounts-merge/)  
55. [Smallest String With Swaps](https://leetcode.com/problems/smallest-string-with-swaps/)  
56. [Satisfiability of Equality Equations](https://leetcode.com/problems/satisfiability-of-equality-equations/)  
57. [Regions Cut By Slashes](https://leetcode.com/problems/regions-cut-by-slashes/)  
58. [Number of Islands II](https://leetcode.com/problems/number-of-islands-ii/)  
59. [Graph Connectivity With Threshold](https://leetcode.com/problems/graph-connectivity-with-threshold/)  
60. [Minimize Malware Spread](https://leetcode.com/problems/minimize-malware-spread/)  
61. [Minimize Malware Spread II](https://leetcode.com/problems/minimize-malware-spread-ii/)  
62. [Checking Existence of Edge Length Limited Paths](https://leetcode.com/problems/checking-existence-of-edge-length-limited-paths/)  
63. [Last Day Where You Can Still Cross](https://leetcode.com/problems/last-day-where-you-can-still-cross/)  
64. [Maximum Number of Fish in a Grid](https://leetcode.com/problems/maximum-number-of-fish-in-a-grid/)  
65. [Count Unreachable Pairs of Nodes](https://leetcode.com/problems/count-unreachable-pairs-of-nodes-in-an-undirected-graph/)

### **Phase 5: Advanced Topics** 

66\. [Min Cost to Connect All Points](https://leetcode.com/problems/min-cost-to-connect-all-points/) 

67\. [Connecting Cities With Minimum Cost](https://leetcode.com/problems/connecting-cities-with-minimum-cost/) 

68\. [Optimize Water Distribution in a Village](https://leetcode.com/problems/optimize-water-distribution-in-a-village/)

69\. [Critical Connections in a Network](https://leetcode.com/problems/critical-connections-in-a-network/) 

70\. [Find Critical and Pseudo-Critical Edges in MST](https://leetcode.com/problems/find-critical-and-pseudo-critical-edges-in-minimum-spanning-tree/)

71\. [Is Graph Bipartite?](https://leetcode.com/problems/is-graph-bipartite/) 

72\. [Possible Bipartition](https://leetcode.com/problems/possible-bipartition/) 

73\. [Divide Nodes Into the Maximum Number of Groups](https://leetcode.com/problems/divide-nodes-into-the-maximum-number-of-groups/)

74\. [Reconstruct Itinerary](https://leetcode.com/problems/reconstruct-itinerary/)

 75\. [Bus Routes](https://leetcode.com/problems/bus-routes/) 

76\. [Shortest Path Visiting All Nodes](https://leetcode.com/problems/shortest-path-visiting-all-nodes/) 

77\. [Minimum Number of Days to Disconnect Island](https://leetcode.com/problems/minimum-number-of-days-to-disconnect-island/) 

78\. [Reachable Nodes In Subdivided Graph](https://leetcode.com/problems/reachable-nodes-in-subdivided-graph/) 

79\. [Shortest Path to Get All Keys](https://leetcode.com/problems/shortest-path-to-get-all-keys/)

 80\. [Sliding Puzzle](https://leetcode.com/problems/sliding-puzzle/)
...
19\. [Planet Queries I](https://cses.fi/problemset/task/1750) 

20\. [Planet Queries II](https://cses.fi/problemset/task/1160)

**Tree Algorithms:** 

21\. [Subordinates](https://cses.fi/problemset/task/1674) 

22\. [Tree Matching](https://cses.fi/problemset/task/1130) 

23\. [Tree Diameter](https://cses.fi/problemset/task/1131) 

24\. [Tree Distances I](https://cses.fi/problemset/task/1132) 

25\. [Tree Distances II](https://cses.fi/problemset/task/1133) 

26\. [Company Queries I](https://cses.fi/problemset/task/1687) 

27\. [Company Queries II](https://cses.fi/problemset/task/1688) 

28\. [Distance Queries](https://cses.fi/problemset/task/1135) 

29\. [Counting Paths](https://cses.fi/problemset/task/1136) 

30\. [Subtree Queries](https://cses.fi/problemset/task/1137)

**Advanced Topics:**

 31\. [Path Queries](https://cses.fi/problemset/task/1138) 

32\. [Path Queries II](https://cses.fi/problemset/task/2134) 

33\. [Distinct Routes](https://cses.fi/problemset/task/1711) 

34\. [Police Chase](https://cses.fi/problemset/task/1695) 

35\. [School Dance](https://cses.fi/problemset/task/1696) 

36\. [Coin Collector](https://cses.fi/problemset/task/1686) 

37\. [Mail Delivery](https://cses.fi/problemset/task/1691) 

38\. [De Bruijn Sequence](https://cses.fi/problemset/task/1692) 

39\. [Teleporters Path](https://cses.fi/problemset/task/1693) 

40\. [Hamiltonian Flights](https://cses.fi/problemset/task/1690)
...
2. [Learning Languages](https://codeforces.com/problemset/problem/277/A)  
3. [DZY Loves Chemistry](https://codeforces.com/problemset/problem/445/B)  
4. [Greg and Graph](https://codeforces.com/problemset/problem/295/B)  
5. [King's Path](https://codeforces.com/problemset/problem/242/C)

**Rating 1400-1600 (Intermediate):** 

6\. [News Distribution](https://codeforces.com/problemset/problem/1167/C) 

7\. [Fox And Names](https://codeforces.com/problemset/problem/510/C) 

8\. [Dijkstra?](https://codeforces.com/problemset/problem/20/C) 

9\. [Road Construction](https://codeforces.com/problemset/problem/330/B) 

10\. [Checkposts](https://codeforces.com/problemset/problem/427/C)

**Rating 1600-1800 (Advanced):** 

11\. [Xenia and Tree](https://codeforces.com/problemset/problem/342/E) 

12\. [Edges in MST](https://codeforces.com/problemset/problem/160/D) 

13\. [Beautiful Graph](https://codeforces.com/problemset/problem/1093/D) 

14\. [Minimum spanning tree for each edge](https://codeforces.com/problemset/problem/609/E) 

15\. [Scheme](https://codeforces.com/problemset/problem/22/E)

**Rating 1800-2000 (Expert):** 

16\. [The Door Problem](https://codeforces.com/problemset/problem/776/D) 

17\. [Digit Tree](https://codeforces.com/problemset/problem/715/C) 

18\. [Tourist Reform](https://codeforces.com/problemset/problem/732/F) 

19\. [Ideal Path](https://codeforces.com/problemset/problem/1221/D) 

20\. [Bosses](https://codeforces.com/problemset/problem/1327/E)

### **AtCoder Problems**

These contests have excellent problem quality. Focus on problems D, E, F from ABC contests.

1. [ABC139D \- ModSum](https://atcoder.jp/contests/abc139/tasks/abc139_d)  
2. [ABC160D \- Line++](https://atcoder.jp/contests/abc160/tasks/abc160_d)  
3. [ABC168D \- Double Dots](https://atcoder.jp/contests/abc168/tasks/abc168_d)  
4. [ABC170D \- Not Divisible](https://atcoder.jp/contests/abc170/tasks/abc170_d)  
5. [ABC213D \- Takahashi Tour](https://atcoder.jp/contests/abc213/tasks/abc213_d)

### **SPOJ Classic Problems**

1. [SHPATH \- The Shortest Path](https://www.spoj.com/problems/SHPATH/)  
2. [PRIM \- Prim Algorithm](https://www.spoj.com/problems/PRIM/)  
3. [SUBMERGE \- Submerge](https://www.spoj.com/problems/SUBMERGE/)  
4. [LCA \- Lowest Common Ancestor](https://www.spoj.com/problems/LCA/)  
5. [QTREE \- Query on a tree](https://www.spoj.com/problems/QTREE/)  
6. [QTREE2 \- Query on a tree II](https://www.spoj.com/problems/QTREE2/)  
7. [FASTFLOW \- Fast Maximum Flow](https://www.spoj.com/problems/FASTFLOW/)
