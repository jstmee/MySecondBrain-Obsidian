...
convert 2d to 1d think what should be done
...
**2.insert at bottom/any indx of the stack using another stack and using recursion**  
**3.remove at bottom/indx of stack using another and recursion**  
...
**Ques1 nearest greater right, left, nearest lesser right ,left imp**  
...
[**https://leetcode.com/problems/find-the-number-of-subarrays-where-boundary-elements-are-maximum/description/**](https://leetcode.com/problems/find-the-number-of-subarrays-where-boundary-elements-are-maximum/description/)
...
**Sol**  
**Method is using two stack how think think then optimize it for o1**  
**Use of 2x-min element and its opposite vvimp**
